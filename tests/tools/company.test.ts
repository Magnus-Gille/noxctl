...
describe('company tools', () => {
  ...
  describe('fortnox_company_info', () => {
    it('fetches company information', async () => {
      mockFetch({
        CompanyInformation: {
          CompanyName: 'Magnus Gille Consulting AB',
          OrganisationNumber: '559123-4567',
          Address: 'Storgatan 1',
          ZipCode: '11122',
          City: 'Stockholm',
          Country: 'SE',
          Email: 'magnus@gille.se',
      ...
      expect(parsed.CompanyName).toBe('Magnus Gille Consulting AB');
      expect(parsed.OrganisationNumber).toBe('559123-4567');
